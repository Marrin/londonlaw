...
# Command-line launcher for detective_simple AI.  Use it like
# $ python detective_simple_launcher.py "gameroom name" PORT
...
from londonlaw.aiclients import detective_simple
...
f = detective_simple.DetectiveSimpleAIFactory(sys.argv[1].decode("utf-8"), sys.argv[2].decode("utf-8"))
